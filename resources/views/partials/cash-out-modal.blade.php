                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="amount" step="0.01" placeholder="Enter amount" required
                                class="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-danger-muted/50 font-semibold text-lg" />
                        </div>
                    </div>
                    <div>
