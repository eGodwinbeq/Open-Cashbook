        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 text-xs font-bold uppercase tracking-widest text-gray-400">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-600 dark:text-gray-300">New Contact</span>
                </div>
            </li>
        </ol>
    </nav>
    <h1 class="text-3xl font-black tracking-tight dark:text-white">New Contact</h1>
</div>

<div class="max-w-3xl">
    <form method="POST" action="{{ route('contacts.store') }}" class="bg-white dark:bg-[#25282c] rounded-2xl shadow-sm border border-[#eaeff0] dark:border-gray-700 p-6">
        @csrf
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="type" value="person" checked required class="mr-2">
                        <span class="text-sm font-semibold dark:text-gray-300">👤 Person</span>
                    </label>
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="type" value="organization" required class="mr-2">
...
<script>
    // Toggle company/tax fields based on type
